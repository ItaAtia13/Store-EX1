...
public class User {
    ...
    public User(String firstName, String lastName, boolean isVIP, Rank rank, String username, String password,
                String userType) {
    ...
    public void printAllCustomers(Store store) {
        //flag is down when  didn't found a Customer in the list
        int flag = 0;
...
//            if (store.users.isEmpty())
    ...
    public void printMadePurchase(Store store) {
        ...
        if (flag == 0) {
            System.out.println("There is no Customer that has made a purchase");
        }
    }
    ...
    public void printTopCustomer(Store store) {
        ...
        System.out.println("The customer whose purchase amount is the highest is :" + topCustomer.getFirstName() + " " +
                topCustomer.getLastName() + " the purchase amount: " + topCustomer.getCostOfPurchases());
    ...
    public void changeProductStatus(Store store) {
        ...
        System.out.println(
                "How would you like to change this product's status?\n1:Set it's amount in stock\n-1:Make it out of stock");
    ...
    public void rankDiscount(Customer customer) {
        switch (customer.getRank()) {
            // REGULAR CUSTOMERS DOESN'T HAVE DISCOUNT
            case CUSTOMER:
